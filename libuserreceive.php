...
<head>
    ...
    <!-- <link rel="stylesheet" href="libuserreceivecss.css"> -->
...
ul {
  ...
  .active {
    background-color: #fc1414;
      ...
      .receivebks input:hover, textarea:hover {
      border: 1px solid ;
...
<center>
<div class="container">
<div class="receivebks"><br>
    <form name="f1" action="libuserreceivedb.php" method="POST" onsubmit="return validation()">
        <h1><b>Receive Book</b></h1>
        <p>student Id</p>
        ...
        <p>received Date</p>
        <input type="Date" name="receiveddate" placeholder="Date" required>
