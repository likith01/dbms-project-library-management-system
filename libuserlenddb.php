...
// $sql0 = "SELECT no_of_copies FROM book WHERE bid = '$bookid'";
// $result0 = mysqli_query($conn, $sql0);
$sql = "INSERT INTO lend(usn, bid, lend_date, due_date) VALUES('$studentId', '$bookid','$lenddate', '$duedate')";
