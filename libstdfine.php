...
<head>
    ...
    <!--css link-->
    <!-- <link rel="stylesheet" href="libstdfinecss.css"> -->
    <!--fonts dns-->
...
ul {
  ...
  .active {
    background-color: #fc1414;
      ...
      .finebks input:hover, textarea:hover {
      border: 1px solid ;
...
<center>
<div class="container">
<div class="finebks"><br>
    <form name="f1" action="libstdfinedb.php" method="POST" onsubmit="return validation()">
        <h1 style="color: white;"><b>Fine details</b></h1>
        <!-- <p>Student Id</p> -->
        <input type="number" id="bid" name="studentId" placeholder="Student Id" required>
