...
<head>
    ...
    <!--css link-->
    <!-- <link rel="stylesheet" href="libstdsearchcss.css"> -->
    <!--fonts dns-->
...
ul {
  ...
  .active {
    background-color: #fc1414;
      ...
      .searchbks input:hover, textarea:hover {
      border: 1px solid ;
...
<center>
<div class="container">
<div class="searchbks"><br>
    <form action="libstdsearchdb.php" name="f1" method="POST" onsubmit="return validation()">
        <h1 style="color: white;"><b>Newspaper</b></h1><br>
        <!-- <p>Book Id</p> -->
            <li><a href="https://kpepaper.asianetnews.com/">Kannada Prabha </a></li>
            <li><a href="https://indianexpress.com/todays-paper/">Indian Express</a></li>
            <li><a href="https://epaper.hindustantimes.com/">Hindustan Times</a></li>
