...
<head>
    ...
    <!--css link-->
    <!-- <link rel="stylesheet" href="libstdcancelcss.css"> -->
    <!--fonts dns-->
...
ul {
  ...
  .active {
    background-color: #fc1414;
      ...
      .cancelbks input:hover, textarea:hover {
      border: 1px solid ;
...
<div class="container">
<div class="cancelbks">
    <form action="libstdcanceldb.php" id="f1" method="POST" onsubmit="return validation()">
        <h1 style="color: white;"><b>Cancel Order</b></h1><br>
        <!-- <p>Book Id</p> -->
        <input type="number" id="bid" name="bookId" placeholder="Book Id" required><br>
        <!-- <p>student Id</p> -->
        <input type="number" id="sid" name="stdid" placeholder="student Id" required>
        <button type="submit" class="btn-btn-default" value="submit">Cancel</button>
    </form>
</div>
</div>
