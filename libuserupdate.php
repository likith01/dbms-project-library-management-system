...
<head>
    ...
    <script>
        function validation()  
            {  
                ...
                if (x <= 0  || z < 0) {
                    alert("Input input constraint voliated");
                    return false;
                 }else {
                    alert("Input  ok");
                    return true;
    ...
    <!-- <link rel="stylesheet" href="libuserupdatecss.css"> -->
...
ul {
  ...
  .active {
    background-color: #fc1414;
      ...
      .updatebks input:hover, textarea:hover {
      border: 1px solid ;
...
<center>
<div class="container">
<div class="updatebks"><br>
    <form name="f1" action="libuserupdatedb.php" method="POST" onsubmit="return validation()">
        <h1><b>Update Book</b></h1><br>
        <!-- <p>Book Id</p> -->
        <input type="number" id="bid" name="bookId" placeholder="Book Id" required>
        <!-- <p>no of copies</p> -->
        <input type="number" id="nc" name="copies" placeholder="book copies" required>
